# Infrastructure for Forecast PoC with SageMaker Studio
...
| **us-east-1** (N. Virginia) | [![Launch Stack](https://s3.amazonaws.com/cloudformation-examples/cloudformation-launch-stack.png)](https://us-east-1.console.aws.amazon.com/cloudformation/home#/stacks/new?stackName=forecastpoc&templateURL=https://public-asean-ml-pocs-us-east-1.s3.amazonaws.com/forecast/ForecastPOC_Studio.yaml) |
...
If you're not already [logged in to AWS ECR Public](https://docs.aws.amazon.com/AmazonECR/latest/public/public-registries.html#public-registry-auth), you'll probably need to do this to be able to run the containerized SAM build:
